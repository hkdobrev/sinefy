 ...
 */
class Kohana_Resource_Jam_Exception_NotFound extends Resource_Exception {
	...
	{
		$this->model = $model;
		parent::__construct($message, Arr::merge(array(':model' => Inflector::humanize(Jam::model_name($model))), (array) $fields));
	}
}