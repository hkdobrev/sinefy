 ...
 */
abstract class Kohana_Jelly_Field_Upload extends Jelly_Field {
	...
	public function create_model_temp(Jelly_Model $model)
	{
	...
	public function _upload(Validation $validation, $model, $field)
	{
		...
		if (is_array($file) AND $file['error'] === UPLOAD_ERR_OK)
		{
			...
			$model->_temp_server
				->filename(Jelly_Field_Upload::sanitize_filename($file['name']))
