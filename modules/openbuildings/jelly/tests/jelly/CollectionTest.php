...
class Jelly_CollectionTest extends Unittest_Jelly_TestCase {
	...
	public function provider_construction()
	{
		...
		return array(
			...
			array(new Jelly_Collection($result->execute($db), 'Model_Test_Post'), 'Model_Test_Post'),
			array(new Jelly_Collection($result->as_object()->execute($db)), FALSE),
			array(new Jelly_Collection(array(array('id' => 1, 'test_author_id' => 1, 'nam' => 'NAME'))), FALSE),
			array(new Jelly_Collection(array(array('id' => 1, 'test_author_id' => 1, 'nam' => 'NAME')), 'Model_Test_Post'), 'Model_Test_Post'),
			array(new Jelly_Collection(array(), 'Model_Test_Post'), 'Model_Test_Post'),
			array(new Jelly_Collection(NULL, 'Model_Test_Post'), 'Model_Test_Post'),
			array(new Jelly_Collection('', 'Model_Test_Post'), 'Model_Test_Post'),
		);
	}
	...
	{
		$posts = Jelly::query('test_post')->select_all();
	...
	{
		$collection = Jelly::query('test_post')->select_all();
