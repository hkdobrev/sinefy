 ...
 * @group   jelly.association.belongs_to
 */
class Jelly_Association_BelongsToTest extends Unittest_Jelly_TestCase {
	...
	{
		$builder = Jelly::factory($builder[0], $builder[1])->builder($builder[2]);
	...
	public function test_model_assignment()
	{
		...
		$test_author = Jelly::factory('test_author', 2);
	...
	{
		$test_copyright = Jelly::factory('test_copyright', 1);
	...
	{
		$test_tag = Jelly::factory('test_tag', 1);
		...
		$post = Jelly::factory('test_tag', 1)->test_post;
	...
	{
		$test_image = Jelly::factory('test_image', 3);
