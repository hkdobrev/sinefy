...
class Jelly_FieldTest extends Unittest_TestCase {
	...
	public function provider_set()
	{
		return array(
			...
			array(new Jelly_Field_Timestamp, '03/15/2010 12:56:32', '03/15/2010 12:56:32'),
			...
			//Weblink
			array(new Jelly_Field_Weblink, 'example.com', 'http://example.com'),
			array(new Jelly_Field_Weblink, 'http://example.com', 'http://example.com'),
			array(new Jelly_Field_Weblink, 'www.example.com', 'http://www.example.com'),
			array(new Jelly_Field_Weblink, '', ''),
			array(new Jelly_Field_Weblink, 'abc.e-fsdf-43xample.com', 'http://abc.e-fsdf-43xample.com'),
			array(new Jelly_Field_Weblink, 'https://example.com', 'https://example.com'),
		);
	}
