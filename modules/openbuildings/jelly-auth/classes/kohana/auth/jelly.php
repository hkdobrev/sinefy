 ...
 */
abstract class Kohana_Auth_Jelly extends Auth {

	protected $_services = array();

	static public function clear_cache()
	{
		Auth_Jelly::$_instance = NULL;
	}
	...
	{
		return is_object($user) ? $user : Jelly::factory('user', $user);
	}

	protected function _load_token($token)
	{
		return is_object($token) ? $token : Jelly::factory('user_token')->get_token($token);
	}
